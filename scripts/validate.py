...
def validate_plugin() -> None:
    ...
    if manifest["name"] != "conductor-swarm" or manifest["version"] != "1.1.1":
...
def main() -> None:
    ...
    validate_plugin()
    print("Validated conductor-swarm, cross-tool-continuity-swarm, and pickup-swarm plus plugin manifest")
